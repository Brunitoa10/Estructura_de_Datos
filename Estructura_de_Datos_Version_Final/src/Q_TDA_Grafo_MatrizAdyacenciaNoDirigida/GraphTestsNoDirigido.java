...
public class GraphTestsNoDirigido {
	...
	@Before
	public void setUp() {
		graph = new GrafoMatrizAdyacenciaNoDirigido<Object, Object>(); // cambiar esta línea para probar
	...
	public void simulation() throws InvalidVertexException, InvalidEdgeException {
		...
		Edge<Object> e2 = graph.insertEdge(v2, v3, new Object());
