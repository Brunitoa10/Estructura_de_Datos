...
public class GraphTests {
	...
	private GraphDirigido<Object, Object> graph;
	private Object o1;
	...
	@Before
	public void setUp() {
		graph = new GrafoDirigidoListaDeAdyacencia<Object, Object>(); // cambiar esta línea para probar
	...
	public void vertices_emptyGraph_returnsEmptyCollection() {
		Iterable<VertexD<Object>> vertices = graph.vertices();
		Iterator<VertexD<Object>> verticesIterator = vertices.iterator();
	...
	public void edges_emptyGraph_returnsEmptyCollection() {
		Iterable<EdgeD<Object>> edges = graph.edges();
		Iterator<EdgeD<Object>> edgesIterator = edges.iterator();
	...
	public void incidentEdges_vertexWithoutEdges_returnsEmptyCollection() throws InvalidVertexException {
		VertexD<Object> v1 = graph.insertVertex(new Object());
		Iterable<EdgeD<Object>> incidentEdges = graph.incidentEdges(v1);
		Iterator<EdgeD<Object>> edgesIterator = incidentEdges.iterator();
	...
	public void opposite_nullVertex_throwsIVE() throws InvalidVertexException, InvalidEdgeException {
		VertexD<Object> v1 = graph.insertVertex(new Object());
		VertexD<Object> v2 = graph.insertVertex(new Object());
		EdgeD<Object> e = graph.insertEdge(v1, v2, new Object());
	...
	public void opposite_edgeNotConnected_throwsIEE() throws InvalidEdgeException, InvalidVertexException {
		...
		VertexD<Object> v2 = graph.insertVertex(new Object());
		EdgeD<Object> e = graph.insertEdge(v1, v2, new Object());
		VertexD<Object> v3 = graph.insertVertex(new Object());
		graph.opposite(v3, e);
	}
	...
	public void endVertices_normalBehavior_returnsEndVertexs() throws InvalidVertexException, InvalidEdgeException {
		...
		VertexD<Object> v2 = graph.insertVertex(new Object());
		EdgeD<Object> e = graph.insertEdge(v1, v2, new Object());
		VertexD<Object> endVertices[] = graph.endvertices(e);
	...
	public void replace_nullVertex_throwsIVE() throws InvalidVertexException {
		VertexD<Object> test = null;
		graph.replace(test, new Object());
	}
	...
	public void replace_validVertex_returnsOldElement() throws InvalidVertexException {
		VertexD<Object> v1 = graph.insertVertex(o1);
	...
	public void insertEdge_emptyGraph_returnsInsertedEdge() throws InvalidVertexException {
		VertexD<Object> v1 = graph.insertVertex(new Object());
		VertexD<Object> v2 = graph.insertVertex(new Object());
		EdgeD<Object> e = graph.insertEdge(v1, v2, o1);
	...
	public void insertEdge_emptyGraph_EdgeInV1AdjacencyList() throws InvalidVertexException, InvalidEdgeException {
		...
		VertexD<Object> v2 = graph.insertVertex(new Object());
		EdgeD<Object> e = graph.insertEdge(v1, v2, o1);
		Iterable<EdgeD<Object>> incidentEdgesV1 = graph.incidentEdges(v1);
		Iterator<EdgeD<Object>> edgesIteratorV1 = incidentEdgesV1.iterator();
		assertTrue(
	...
	public void insertEdge_emptyGraph_EdgeInV2AdjacencyList() throws InvalidVertexException, InvalidEdgeException {
		...
		VertexD<Object> v2 = graph.insertVertex(new Object());
		EdgeD<Object> e = graph.insertEdge(v1, v2, o1);
		Iterable<EdgeD<Object>> incidentEdgesV2 = graph.incidentEdges(v2);
		Iterator<EdgeD<Object>> edgesIteratorV2 = incidentEdgesV2.iterator();
		assertTrue(
				"Luego de insertar un arco a partir de un dado vértice, se sigue retornando una colección vacía en los arcos incidentes de dicho vértice.",
	...
	public void removeEdge_validEdge_removedFromPredecessorIncidentEdges() throws InvalidVertexException, InvalidEdgeException {
		...
		EdgeD<Object> e = graph.insertEdge(v1, v2, new Object());
		graph.removeEdge(e);
		Iterable<EdgeD<Object>> edgesV1 = graph.incidentEdges(v1);
		Iterator<EdgeD<Object>> edgesIteratorV1 = edgesV1.iterator();
	...
	public void removeEdge_validEdge_removedFromSuccessorIncidentEdges() throws InvalidVertexException, InvalidEdgeException {
		...
		EdgeD<Object> e = graph.insertEdge(v1, v2, new Object());
		graph.removeEdge(e);
		Iterable<EdgeD<Object>> edgesV2 = graph.incidentEdges(v2);
		Iterator<EdgeD<Object>> edgesIteratorV2 = edgesV2.iterator();
	...
	public void simulation() throws InvalidVertexException, InvalidEdgeException {
		...
		VertexD<Object> v3 = graph.insertVertex(new Object());
		VertexD<Object> v4 = graph.insertVertex(new Object());
		
		Iterable<VertexD<Object>> vertices = graph.vertices();
		Iterator<VertexD<Object>> iteradorVertices = vertices.iterator();
		...
		EdgeD<Object> e1 = graph.insertEdge(v1, v2, new Object());
		EdgeD<Object> e2 = graph.insertEdge(v1, v3, new Object());
		EdgeD<Object> e3 = graph.insertEdge(v3, v4, new Object());
		...
		Iterable<EdgeD<Object>> arcos = graph.edges();
		Iterator<EdgeD<Object>> iteradorArcos = arcos.iterator();
		int contadorArcos = 0;
